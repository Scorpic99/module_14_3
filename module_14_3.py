...
async def get_buying_list(message: types.Message):
    num = 1
    with open(f'BAA/pr{num}.jpg', 'rb') as prod:
        await message.answer_photo(prod, f"Название: Product{num} | Описание: описание {num} | Цена: {num * 100}")
    num = 2
    with open(f'BAA/pr{num}.jpg', 'rb') as prod:
        await message.answer_photo(prod, f"Название: Product{num} | Описание: описание {num} | Цена: {num * 100}")
    num = 3
    ...
    num = 4
    with open(f'BAA/pr{num}.jpg', 'rb') as prod:
        await message.answer_photo(prod, f"Название: Product{num} | Описание: описание {num} | Цена: {num * 100}", reply_markup=inline_button_products)
